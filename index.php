...
$query_RSRandomPages = "SELECT *,rand() AS random_row FROM tbl_pages WHERE page_active=1 ORDER BY ".random_row." LIMIT 10";
...
<meta name="description" content="Like my FanPage is a web directory of Facebook Fan Pages. Search for Fan Pages to like or submit your Fan Page to get more fans.">
<meta name="keywords" content="facebook page directory,facebook fanpage directory, facebook fanpages directory, facebook fan pages directory,list of facebook fan pages,like my fanpage, like my fan page">
...
<title>Like My FanPage | Facebook Fan Page Directory</title>
<!-- InstanceEndEditable -->
    ...
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
		...
		<!-- InstanceBeginEditable name="pagebody" -->
          <p><strong>Currently Displaying 10 RANDOM Facebook Fan Pages every 30 seconds.</strong></p>
		  <?php do { ?>
            <div class="frontPageBoxes"><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like-box href="<?php echo $row_RSRandomPages['page_url'] ?>" width="250" show_faces="true" border_color="" stream="false" header="false"></fb:like-box><div class="reportPage"><a onClick="confirmation('/reportbug.php?id=<?php echo $row_RSRandomPages['tbl_id']; ?>','ReportDeadLink','width=300,height=100')"><span class="img rbugicon"></span></a></div></div>
