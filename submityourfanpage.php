...
<title>Submit your FanPage to likemyfanpage.com</title>
<!-- InstanceEndEditable -->
  ...
  <?php include('scripts/leftnav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
		...
		?>	  
		    <p>Please complete the form below to submit your FanPage:</p>
			<form action="scripts/addfanpage.php" method="POST" name="form1">
		    <br><br>
		    <!--[if IE]>Please Enter Your FanPage Name:<br><![endif]-->
            <input name="pageName" id="pageName" class="pageName" placeholder="Please Enter Your FanPage Name" type="text">
            <br><br>
		    <!--[if IE]>Please Enter Your FanPage URL:<br><![endif]-->
            <input name="pageURL" id="pageURL" class="pageURL" placeholder="Please Enter Your FanPage URL" type="url">
            ...
            <p><input name="Submit" type="Submit" class="searchBox" id="Submit" style="width:75px;" onClick="return pagesubmitform();" value="Submit">&nbsp;&nbsp;&nbsp;<input name="Reset" type="reset" class="searchBox" id="Reset" style="width:75px;" value="Reset"></p>
		    <input type="hidden" name="MM_insert" value="form1"><input type="hidden" name="UsrId" value="<?php echo $row_RSUser['tbl_id']; ?>"></form>
		<?php  
          }
        ?>
      <!-- InstanceEndEditable -->
