...
$query_RSPages = "SELECT * FROM tbl_pages ORDER BY page_name ASC";
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        ...
        <br>
        <?php if ($_GET["msg"] == 1) { echo "<p class='centerme'><strong>Page Deleted</strong></p>"; } ?>
        <?php if ($_GET["msg"] == 2) { echo "<p class='centerme'><strong>Page Updated</strong></p>"; } ?>
