...
$query_RSPages = "SELECT * FROM tbl_pages WHERE usr_id=".$_GET["u"]." ORDER BY page_name ASC";
...
mysql_select_db($database_Wisdom_Mcr, $Wisdom_Mcr);
$query_RSUser = "SELECT * FROM tbl_usrs WHERE tbl_id=".$_GET["u"];
...
<div id="globalContainer">
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        <h1 class="lfloat"><!-- InstanceBeginEditable name="pageheader" -->Pages By User (<?php echo ucwords($row_RSUser["usr_fname"]." ".$row_RSUser["usr_sname"]); ?>)<!-- InstanceEndEditable --></h1><br class="cboth">
