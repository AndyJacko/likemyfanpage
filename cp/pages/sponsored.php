...
$query_RSPages = "SELECT * FROM tbl_pages WHERE page_sponsored=1 ORDER BY page_name ASC";
...
<div id="globalContainer">
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        <h1 class="lfloat"><!-- InstanceBeginEditable name="pageheader" -->Sponsored Pages<!-- InstanceEndEditable --></h1><br class="cboth">
