...
$query_RSUsers = "SELECT * FROM tbl_usrs WHERE usr_subscribed=0";
...
<div id="globalContainer">
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        <h1 class="lfloat"><!-- InstanceBeginEditable name="pageheader" -->Unsubscribed Users<!-- InstanceEndEditable --></h1><br class="cboth">
