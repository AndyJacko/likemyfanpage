...
$query_RSUsers = "SELECT tbl_usrs.tbl_id,tbl_usrs.usr_fname,tbl_usrs.usr_subscribed,tbl_usrs.usr_sname,tbl_usrs.usr_email,tbl_usrs.usr_pass,tbl_usrs.usr_active FROM tbl_usrs INNER JOIN tbl_pages ON tbl_usrs.tbl_id = tbl_pages.usr_id GROUP BY tbl_usrs.tbl_id";
...
<div id="globalContainer">
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        <h1 class="lfloat"><!-- InstanceBeginEditable name="pageheader" -->Users With Pages<!-- InstanceEndEditable --></h1><br class="cboth">
