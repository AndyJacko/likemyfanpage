...
$query_RSUsers = "SELECT * FROM tbl_usrs WHERE usr_active=1";
...
<div id="globalContainer">
  ...
  <?php include('../../scripts/cp/cp-nav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        <h1 class="lfloat"><!-- InstanceBeginEditable name="pageheader" -->Confirmed Users<!-- InstanceEndEditable --></h1><br class="cboth">
