...
<meta name="description" content="Follow along with some step-by-step tutorials and learn how to get more likes on your Facebook Fan Pages">
<meta name="keywords" content="what is facebook fan page,what is a facebook fan page,fan page in facebook,facebook fan page how to">
<!-- InstanceEndEditable -->
<!-- InstanceBeginEditable name="doctitle" -->
<title>Learn how to get more fans to your FanPages</title>
<!-- InstanceEndEditable -->
  ...
  <?php include('scripts/leftnav.php');?>
    <div id="contentCol" class="clearfix">
      <div id="headerArea">
        ...
        <p class="justify">Here you will find some easy-to-follow tutorials to help you maximise the fanbase of your Facebook Fan Pages.  We will also be sharing some of our own "secret" methods to monetise and automate your Facebook Fan Pages.</p>
        <h2 class="justify">Tutorials Coming Soon:</h2>
        <br>
        <div class="linkcols">
          <ul>
            <li>Posting Status Updates</li>
            <li>Using Status Tagging</li>
            <li>Linking Your Job To Your Page</li>
            <li>Using Your Email Signature</li>
            <li>Creating FBML/iFrame Pages</li>
            <li>Creating A Username</li>
            <li>Creative Use Of Links</li>
            <li>Facebook Badges</li>
            <li>Photo Tagging</li>
